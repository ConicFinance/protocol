...
contract RewardsHandlerTest is ConicPoolBaseTest {
    ...
    function setUp() public override {
        ...
        weights[0] = IConicPoolWeightManagement.PoolWeight(CurvePools.TRI_POOL, 0.4e18);
        weights[1] = IConicPoolWeightManagement.PoolWeight(CurvePools.FRAX_3CRV, 0.6e18);
        ...
        newWeights[0] = IConicPoolWeightManagement.PoolWeight(CurvePools.TRI_POOL, 0.2e18);
        newWeights[1] = IConicPoolWeightManagement.PoolWeight(CurvePools.FRAX_3CRV, 0.8e18);
